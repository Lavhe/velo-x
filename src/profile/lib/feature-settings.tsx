...
import {Input, Loader, SingleListPicker, SingleSelect} from 'velo-x/ui';
import {
  Type as ProfileType,
  schema,
  typeSchema,
...
export function Settings(props: SettingsProps) {
  ...
  return (
    <ScrollView style={ClassNames.Row}>
      <View style={tw`flex gap-6 px-2`}>
        ...
        />
        <Text style={tw`font-bold text-lg py-2 text-white text-center`}>
          Vehicle details
        </Text>
