...
const ClassNames = {
  Card: tw`flex align-center text-center my-auto dark:bg-gray-600 shadow-radius-1 shadow-color-opacity-100 rounded-xl m-2 px-4 py-2`,
  SelectedCard: tw`flex align-center text-center bg-white dark:bg-gray-800 shadow-lg shadow-radius-1 shadow-color-opacity-100 rounded-xl m-2 px-4 py-2`,
  ...
  SelectedTitle: tw`text-center text-lg font-bold my-auto text-white`,
